...
def main():
    ...
    print("Preparing RhiresD dataset")
    ds_new = xr.Dataset(
        {"rhiresd": ds["RhiresD"].transpose("N", "E", "time")},
        coords={
            "lat": ds["lat"],
            "lon": ds["lon"],
            "time": ds["time"]
    ...
    grid_path = "tmp_grid_01.nc"
    input_path = "tmp_rhiresd_01.nc"
    tmp_output = "tmp_01.nc"
    ...
    final_output = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/sasthana/Downscaling/Downscaling_Data_Prep/rhiresd_conservatively_regridded_12km_versionbash.nc"
